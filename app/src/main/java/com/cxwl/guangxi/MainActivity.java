			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				if (TextUtils.equals(dto.showType, CONST.URL)) {
					...
					if (TextUtils.equals(dto.id, "104")) {//台风动态
						...
						intent = new Intent(mContext, FactActivity2.class);//气温实况
						intent.putExtra(CONST.ACTIVITY_NAME, dto.name);
						intent.putExtra(CONST.WEB_URL, dto.dataUrl);
						...
						intent = new Intent(mContext, FactActivity2.class);//风向风速
						intent.putExtra(CONST.ACTIVITY_NAME, dto.name);
						intent.putExtra(CONST.WEB_URL, dto.dataUrl);
						intent.putExtra(CONST.COLUMN_ID, dto.id);
						Bundle bundle = new Bundle();
						...
						intent = new Intent(mContext, FactActivity2.class);//雨情雨量o
						intent.putExtra(CONST.ACTIVITY_NAME, dto.name);
						intent.putExtra(CONST.WEB_URL, dto.dataUrl);
						intent.putExtra(CONST.COLUMN_ID, dto.id);
						Bundle bundle = new Bundle();
